"""
Pipeline Step 3 — Transcript ingestion and parsing.

Input:  raw speaker-labeled text  ("SpeakerName: text content")
Output: list of Turn objects      (structured, normalized, ready for extraction)
